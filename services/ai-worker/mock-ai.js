...
fs.writeFileSync(path.join(out,'ai-worker-schema.json'), JSON.stringify({status, requiredFields:['event','catalyst','theme','theme_chain','companies','evidences','risks','observation_points','compliance'], card},null,2));
